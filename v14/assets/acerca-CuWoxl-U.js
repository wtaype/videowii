  ...
  <div class="acerca_container">
    ...
    <section class="acer_hero">
      ...
      <div class="hero_visual">
        <img src="/videowii/v14/hero.webp" alt="${i} Hero" class="hero_img" loading="lazy">
    ...
    <section class="creador_section">
      <div class="creador_card">
        <div class="creador_visual">
          <img src="/videowii/v14/wilder.webp" alt="${c}" class="creador_foto">
