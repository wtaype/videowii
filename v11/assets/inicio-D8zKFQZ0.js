    ...
    <section class="hero">
      ...
      <div class="hero_visual">
        <div class="img_container">
          ...
          <img src="/videowii/v11/hero.webp" alt="${n} - Editor Profesional" class="hero_img" loading="eager">
