import{j as e}from"./vendor-gzd0YkcT.js";import{c as r,w as n,d as v,S as p}from"./main-BnUtqRuz.js";import"./main-BLsNIjRn.js";const _=[{icon:"fa-compress-arrows-alt",title:"Optimizar",desc:"Reduce el tamaño de tus videos MP4, AVI y más sin perder calidad usando FFmpeg",color:"--success",link:"/optimizar",emoji:"🚀"},{icon:"fa-palette",title:"Editar",desc:"Mejora tus videos: ajusta brillo, contraste, velocidad y filtros profesionalmente",color:"--Mora",link:"/editar",emoji:"🎨"},{icon:"fa-exchange-alt",title:"Convertir",desc:"Transforma tus videos a MP4, MKV, AVI, MOV, WEBM y FLV fácilmente",color:"--info",link:"/conversor",emoji:"🔄"},{icon:"fa-globe",title:"Online",desc:"Visualiza videos de YouTube, TikTok, Facebook y Twitch sin anuncios",color:"--warning",link:"/online",emoji:"🌐"}],f=[{number:4,label:"Herramientas de Video",suffix:"+"},{number:100,label:"Privacidad Total",suffix:"%"},{number:10,label:"Formatos Soportados",suffix:"+"},{number:4,label:"Calidad Soportada",suffix:"K"}],m=["🎬 Edición Profesional","🚀 Optimización Rápida","🔄 Conversión Universal","🌐 Visor Multiplataforma"],b=()=>`
