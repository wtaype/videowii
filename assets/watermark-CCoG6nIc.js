import{j as a}from"./vendor-gzd0YkcT.js";import{c as F,N as p,i as T}from"./main-B6BHQIRD.js";import"./main-C1gCMgpG.js";const S=(()=>{if(typeof window>"u")return"";const l=window.location.hostname;return new Set(["localhost",T]).has(l)?`http://${l}:3000`:window.location.origin})(),V=()=>`
